...
#File
filename = "/home/pi/soil_data/soil " + "{:%H_%M %m_%d_%Y}".format(datetime.datetime.now()) + ".txt"
...
def Shutdown(channel):
	...
	os.system("sudo killall python && sudo poweroff")
...
while True:
	...
	file.write("{:%Y-%m-%d %H:%M},".format(datetime.datetime.now()))
